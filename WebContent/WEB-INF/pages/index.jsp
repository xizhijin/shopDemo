...
<body>
	...
	<div id="box">
		<div id="left">
			...
			<div id="left_s02"><img src="${context_path}/css/images/index_25.gif" width="489" height="245" class="imgz5" /></div>
			<!-- 类别 -->
				...
				<div id="left_x">
					<div id="left122">
						<table style="float: left; height: auto; width: 678px; vertical-align: middle;">
							<tr>
								<td class="word14" style="width: 22px; padding-left: 10px;"><s:property value="name" /></td>
		...
		<div id="right">
			...
			<div id="xpss">
				<table width="195" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td valign="top"><s:action name="product_findByCommend" namespace="/product" executeResult="true" /></td>
					</tr>
				</table>
			</div>
			<!-- 热销商品 -->
			<div id="rxsp">
				<table width="195" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td valign="top"><s:action name="product_findBySellCount" namespace="/product" executeResult="true" /></td>
					</tr>
				</table>
			</div>
