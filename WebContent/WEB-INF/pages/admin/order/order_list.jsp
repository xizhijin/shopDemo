					...
					<li>
						<table width="693" height="29" border="0">
							<tr>
								...
								<td width="60" align="center"><s:property
										value="totalPrice" /></td>
								<td width="63" align="center"><s:property
										value="customer.username" /></td>
								<td width="70" align="center"><s:property
										value="paymentWay.getName()" /></td>
								<td width="140" align="center"><s:date name="createTime"
										format="yyyy年MM月d日 HH:mm" /></td>
								<td width="70" align="center"><s:property
										value="orderState.getName()" /></td>
								<td width="150" align="center"><s:url action="order_select"
										namespace="/admin/product" var="order_select">
