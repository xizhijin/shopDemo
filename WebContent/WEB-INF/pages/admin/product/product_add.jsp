...
<s:form action="product_save" namespace="/admin/product" enctype="multipart/form-data" method="post">
	<div id="right">
		<div id="right_top">
			<img src="${context_path}/css/images/blue.gif" width="16" height="16" /><span class="word01">添加商品</span>
		</div>
		<div id="right_mid">
			<div id="tiao">
				<table width="685" height="24" border="0">
					...
					<tr>
						...
						<td><s:select name="sexrequest" list="@com.lyq.model.Sex@getValues()"></s:select></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><s:textarea name="description" cols="50" rows="6"  /></td>
					</tr>
				</table>
				<!-- Redesign -->
				<div align="center">
					<s:submit type="image" src="%{context_path}/css/images/ht_02_18.gif" />
				</div>
			</div>
		</div>
		<%-- 
