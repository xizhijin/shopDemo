...
<div id="right">
	<div id="right_top01">
		<table width="690" height="29" border="0" class="word01">
			<tr>
	...
	<div id="right_mid">
		<div id="tiao">
			<s:iterator value="pageModel.list">
				<ul>
					<li>
						<table width="690" height="29" border="0">
							<tr>
								<td width="50" height="27" align="center"><s:property value="id" /></td>
								<td width="150" align="center">
									<s:a action="category_add" namespace="/admin/product"><s:param name="pid" value="id" /><s:property value="name" /></s:a>
								</td>
								<td width="150" align="center">
									<s:if test="children == null || children.isEmpty">没有子类别</s:if> 
									<s:else>
										<s:a action="category_list" namespace="/admin/product"><s:param name="pid" value="id"></s:param>有<s:property value="children.size" />个子类别</s:a>
									</s:else>
								</td>
								<td width="100" align="center">
									<s:a action="category_add" namespace="/admin/product"><s:param name="pid" value="id" />添加</s:a></td>
								<td width="100" align="center">
									<s:if test="parent.name != null"><s:property value="parent.name" /></s:if> 
									<s:else>无</s:else>
								</td>
